function compute(){//compute the total amount earned with simple interest
    ...
    if( check_principal() == true)   {//if principal value is valid, display results  
        ...
        "&emsp;" + "If you deposit <mark>" + principal + "</mark>,<br>" +  
        "&emsp;" + "at an interest rate of <mark>" + rate + "%</mark>.<br>" + 
        "&emsp;" + "You will receive an amount of <mark>" + interest + "</mark>, <br>" + 
        "&emsp;" + "in the year <mark>" + tbd + "</mark><br><br>"
    }    
}
